...
const { data:detail } = await useFetch(`/api/video/${params.bvid}`) as any
const { data:videoData } = await useFetch('/api/video') as any 

useSeoMeta({
  title: `${detail.value?.title}_哔哩哔哩 (゜-゜)つロ 干杯~-bilibili`
})
...
<template>
  ...
  <div class="info">
    ...
    <div class="body">
      <div class="author">
        <img class="avatar" :src="detail?.author.face" alt="RuaRuaRua" />
  ...
  <div class="relate">
    ...
    <div class="relate-list">
      <app-video class="relate-list" apiLink="@/api/video" />
    </div>
  </div>
</template>
